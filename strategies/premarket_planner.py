...
def main():
    ...
    schedule.every().monday.at("20:10").do(run_premarket_batch, market="US")
    schedule.every().tuesday.at("20:10").do(run_premarket_batch, market="US")
    schedule.every().wednesday.at("20:10").do(run_premarket_batch, market="US")
    schedule.every().thursday.at("20:10").do(run_premarket_batch, market="US")
    schedule.every().friday.at("20:10").do(run_premarket_batch, market="US")
